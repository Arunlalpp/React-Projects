...
function Header() {
	return (
		<div>
			<div className="bg-[#ffe01b] hover:bg-[#fff] cursor-pointer fixed left-0 right-0 top-0 z-10 ">
				<div className="max-w-[2105.38px] w-full mx-auto box-border ">
					<div className="flex flex-row justify-between items-center h-[7rem]">
						<div className="">
							...
							>
								<li className="text-[16ppx] text-Primary p-5 font-semibold ">
									Products
								</li>
								<li className="text-[16ppx] text-Primary p-5 font-semibold ">
									Resources
