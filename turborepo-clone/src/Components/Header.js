	...
	return (
		<div>
			<div className="flex flex-col bg-[#111111]">
				<header class="z-10 w-full top-0 fixed  border-gray-700 border-b">
					<div className="bg-transparent z-20 w-full top-0 fixed border-gray-700 border-b">
						<div className="shadow-sm absolute w-full h-full  pointer-events-none md:opacity-80 opacity-80"></div>
